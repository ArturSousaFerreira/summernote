...
inputâ€”related to the effective coverage of the declared output domain from the input domain. In other words, it is the ability to control input and 
...
After running the default build and test configurations using grunt, we detected the presence of [147](https://travis-ci.org/summernote/summernote/builds/178270739) passing unit tests. 
