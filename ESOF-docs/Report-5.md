...
We have ran the Better Codehub, later we call only [BC](https://bettercodehub.com/), tool to check ten guidelines for maintainable software in the Summernote project.
...
The [BC](https://bettercodehub.com/) rated this point as a failure and we confirm that, in Summernote, most of units above 15 lines of code, in our opinion, can't 
